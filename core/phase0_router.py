...
_SELF_PATTERNS: tuple[tuple[str, str], ...] = (
    ...
    (
        ...
        "• **أكثر من 49,000 نص قانوني قطري** — جميع القوانين والتشريعات "
        "المنشورة على موقع الميزان.\n"
        "• **11,452 حكم من أحكام محكمة التمييز** — مفصّلة بالكامل.\n"
    ...
    (
        ...
        "• **49,000+ نص قانوني قطري** (قوانين، تشريعات، لوائح).\n"
        "• **11,452 حكم تمييز** مع المبادئ القضائية.\n"
